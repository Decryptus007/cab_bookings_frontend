	...
	return (
		<section className='h-screen p-4 pt-[80px] laptop:px-20 overflow-auto  flex justify-center items-center w-full   '>
			<div className='w-full relative flex justify-center'>
				<div className='w-full  mt-10 py-8  bg-white rounded-lg shadow-lg dark:border my-12 md:my-4  xl:p-8 overflow-auto dark:bg-gray-800 dark:border-gray-700'>
					<div className='p-4 tablet:p-6 space-y-2 md:space-y-4 sm:p-8'>
						<h1 className='text-base flex justify-center mb-8 font-bold leading-tight tracking-tight text-my-primary md:text-2xl  capitalize'>Enter your details to login</h1>
						<form className='space-y-4 tablet:space-y-6 w-full md:w-[450px]' onSubmit={handleSubmit(handleSignIn)}>
							<div>
							...
							<div className='flex flex-col'>
								<p className='text-sm font-light  text-gray-500 dark:text-gray-400'>
									...
									<Link to='/signup' className=' ml-2 hover:text-blue-500 font-semibold text-primary-600 hover:underline dark:text-primary-500'>
										Sign up
									</Link>
								</p>
							</div>
